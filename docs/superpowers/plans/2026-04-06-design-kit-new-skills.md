...
3. **접근성 원칙 무시 금지** — 하이파이 시안이라도 WCAG AA 대비 비율(4.5:1), 터치 타겟(WCAG AA 하한 24×24 CSS px — SC 2.5.8 · Apple HIG 권장 44×44pt · 44×44 는 AAA SC 2.5.5)을 준수하라. 시각적으로 예뻐도 접근성 위반이면 안 된다.
