...
3. **접근성 생략 금지** — 시각적으로 문제없어 보여도 contrast ratio(WCAG AA 4.5:1), 터치 타겟 크기(WCAG AA 하한 24×24 CSS px — SC 2.5.8 · Apple HIG 권장 44×44pt · 44×44 는 AAA SC 2.5.5)는 반드시 검사한다.
...
| 터치 타겟 | Apple HIG 44×44pt 권장 · WCAG AA 하한 24×24 CSS px | Apple HIG · WCAG SC 2.5.8 (AA, 24×24) · SC 2.5.5 (AAA, 44×44) |
