...
| 플러그인 | 버전 | 스택 | 설명 |
|----------|------|------|------|
| [`harness`](./harness/) | v0.4.3 | 범용 | [v0.4.3 · 2026-06-05] Sprint Contract + QA Evaluator 기반 품질 보증 하네스 (2026 QA 자동화 트렌드 반영) |
...
| [`design-kit`](./design-kit/) | v0.2.4 | 범용 | [v0.2.4 · 2026-06-05] 스택 무관 UI/UX 디자인 가이드 + 감사 (OKLCH / DTCG v1 / WCAG 2.2 / Container Queries) |
...
| [`reflect-kit`](./reflect-kit/) | v0.3.2 | 범용 | [v0.3.2 · 2026-06-05] 개인 Claude Code 대화 피드백 → 학습 → 재주입 파이프라인 (Reflexion 방법론) — Hybrid project_id (basename 기본 + 충돌 시 hash fallback · backward-compatible) · 정규화 쿼리 · 내부 디렉토리 자동 제외 · 3 훅 수집 · /reflect-digest 집계 (+ project=all cross-project) · /reflect-promote 승격 + ledger · /reflect-kaizen 30d calibration · codex 실패 시 Claude CLI fallback · install-scheduler/legacy-id-migrate 유틸 |
