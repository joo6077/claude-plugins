...
| [`reflect-kit`](./reflect-kit/) | v0.1.0 | 범용 | [v0.1.0 · 2026-04-17] 개인 Claude Code 대화 피드백 → 학습 → 재주입 파이프라인 (Reflexion 방법론) — 3 훅 수집 · /reflect-digest 집계 · /reflect-promote 승격 + ledger · /reflect-kaizen 30d calibration |
<!-- /AUTO:plugins -->
