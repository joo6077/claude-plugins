...
**범위** — V6 보다 넓다. V6 은 `skills/*/SKILL.md` · `agents/*.md` · `references/*.md` ·
킷 루트 `README.md` 를 보는데, 표가 끊긴 자리는 `harness/docs/guides/` 였고 그건 V6 범위
밖이었다. 그래서 킷 안의 `docs/**/*.md` 를 더한다. 실측 210 파일에서 오탐 0 을 확인한 뒤
도입했다.
