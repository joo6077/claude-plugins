...
11. **OAuth 2.1 draft 명시 (Phase 7 리서치)** — 인증 세팅 시 OAuth 2.1 은 `draft-ietf-oauth-v2-1-16` (2027-03-07 만료) 로 아직 Draft 임을 명시. 실무 기준선은 RFC 9700 BCP. 이미 PKCE 필수, Implicit/ROPC 제거, 엄격 redirect URI 매칭이 적용되어 있다. 출처: [IETF OAuth 2.1 Draft](https://datatracker.ietf.org/doc/draft-ietf-oauth-v2-1/).
