...
| 3 | Non-goals | 최소 3개 명시 (Shape Up 의 no-gos / rabbit holes 포함) + 폐기한 결정마다 이유 · 범위 · 코드에 남은 흔적 칸 + stories · flow · data-model 산출물에 폐기한 항목이 다시 들어가지 않음 (planning-reviewer Step 3 확인) | prd-patterns.md §Shape Up / §폐기한 결정 | [Shape Up §9](https://basecamp.com/shapeup/2.3-chapter-09), [Shape Up §6](https://basecamp.com/shapeup/1.5-chapter-06) |
| 4 | Success Metrics | Leading + Lagging + 기준선 숫자 (vanity metric 아님) | discovery.md §Lean Canvas | [Leanstack](https://leanstack.com/) |
